...
for i in Alumno.alumnos:
    print(i.dar_info())
    print("Promedio de las notas: " + str(i.promedio))
    print("La mayor nota es: " + str(i.mayor_nota))
    print("")
...
nombrePromedio = lista_de_promedios.index(estudianteMejorPromedio(lista_de_promedios))
nombreNota = lista_de_notas.index(estudianteMejorNota(lista_de_notas))
print("+ El estudiante con Mejor Promedio es: " + lista_de_nombres[nombrePromedio] + ", con: " + str(estudianteMejorPromedio(lista_de_promedios)))
print("+ El estudiante con Mejor Nota es: " + lista_de_nombres[nombreNota] + ", con: " + str(estudianteMejorNota(lista_de_notas)))
